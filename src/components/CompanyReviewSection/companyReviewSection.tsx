...
export default function CompanyReviewSection({ page }: Props) {
  return (
    <div className="w-full page-container px-4 sm:px-6 lg:px-8 xl:px-12">
      {page === "/about" && (
        <div className="relative top-[-40px] sm:top-[-80px] lg:top-[-120px] xl:top-[-150px] flex flex-col min-[1280px]:flex-row-reverse items-center gap-8 lg:gap-12 xl:gap-30 mb-12 sm:mb-[120px]">
          <div className="-mx-4 sm:-mx-6 lg:-mx-8 min-[1280px]:mx-0 w-[calc(100%+2rem)] sm:w-[calc(100%+3rem)] lg:w-[calc(100%+4rem)] min-[1280px]:w-1/2 flex justify-center min-[1280px]:justify-end shrink-0 min-[1280px]:max-w-[614px]">
          ...
          <div className="w-full min-[1280px]:flex-1 min-w-0 flex flex-col items-start justify-center gap-4 sm:gap-6 lg:gap-8 max-w-[1362px]">
            <div className="flex flex-col">
              ...
              <p className="font-[500] text-base sm:text-lg lg:text-[19px] xl:text-[20px] leading-relaxed sm:leading-8 xl:leading-[36px] text-dark mt-3 sm:mt-5">
