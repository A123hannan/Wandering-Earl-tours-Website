...
export default function ImageContainer() {
    return (
        <section className="relative mt-[-400px]">
            ...
            <div className="relative z-10 px-4 sm:px-6 lg:px-8 2xl:!px-[80px] py-16 sm:py-24 lg:pb-[150px] pt-16 sm:pt-24 md:pt-32 lg:pt-[165px] xl:pt-[200px] 2xl:pt-[240px]">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5 lg:gap-6">
                    {galleryImages.map((image, i) => {
                        ...
                        return (
                            <div
                                key={i}
                                className={`relative w-full rounded-[16px] sm:rounded-[24px] overflow-hidden shadow-[0_40px_48px_-16px_rgba(0,0,0,0.16)] ${isLast
