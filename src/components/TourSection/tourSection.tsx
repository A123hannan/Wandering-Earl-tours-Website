    ...
    <>
      ...
      <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 sm:gap-0 w-full">
        ...
        <div className="pb-0 sm:pb-[13px] 2xl:pb-[13px]">
          <div className="pt-[13px] px-[31px] pb-[14px] flex flex-row items-center gap-[10px] rounded-[30px] border border-[#1E365C]">
            <Button
              text="All Tours"
              className=""
              textprop="font-[700] text-[16px] leading-[100%] tracking-[0%] text-[#1E365C]"
            />
      ...
      {/* Destination Grid */}
      <div className="w-full grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-6 sm:gap-8 2xl:gap-[20px] pt-8 sm:pt-10 2xl:pt-[32px] [&>*]:min-w-0">
        {cardData.map(
          ({
            badge,
            cardNo,
